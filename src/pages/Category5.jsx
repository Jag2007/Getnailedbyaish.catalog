...
const designs = [
  { label: "Whisper Glitz", src: whisperGlitz, price: 399 },
  { label: "Nude Shimmer", src: nudeShimmer, price: 399 },
  { label: "Glitter Edge", src: glitterEdge, price: 479 },
  { label: "Iridescent Sparkle", src: iridescentSparkle, price: 499 },
  { label: "Silver Swirls", src: silverSwirls, price: 529 },
  { label: "Diamond Outline", src: diamondOutline, price: 549 },
  { label: "Stellar Charm", src: stellarCharm, price: 549 },
  { label: "Diamond Dust French", src: diamondDustFrench, price: 629 },
  { label: "Bridal Bow", src: bridalBow, price: 629 },
  { label: "Floral Charm", src: floralCharm, price: 629 },
  { label: "Glided Wave Tips", src: glidedWaveTips, price: 629 },
  { label: "Haute Lines", src: hauteLines, price: 649 },
  { label: "Golden Embrace", src: goldenEmbrace, price: 649 },
  { label: "French Whirl", src: frenchWhirl, price: 649 },
  { label: "Golden Thread", src: goldenThread, price: 649 },
  { label: "Everyday Ombre Glitter", src: everydayOmbreGlitter, price: 649 },
  { label: "Luxe Swirl", src: luxeSwirl, price: 649 },
  { label: "Starlight Serenade", src: starlightSerenade, price: 649 },
  { label: "Delicate Luxe", src: delicateLuxe, price: 679 },
  { label: "Gold Frame", src: goldFrame, price: 699 },
  { label: "Glided Butterfly Tips", src: glidedButterflyTips, price: 699 },
  { label: "Crystal Tips", src: crystalTips, price: 699 },
  { label: "Starlight Border", src: starlightBorder, price: 699 },
  { label: "Midnight Elegance", src: midnightElegance, price: 599 },
  { label: "Midnight French", src: midnightFrench, price: 599 },
  { label: "Frost and Shine", src: frostAndShine, price: 599 },
  { label: "Nude Glimmer", src: nudeGlimmer, price: 599 },
  { label: "Glided French", src: glidedFrench, price: 599 },
  { label: "Rosy Radience", src: rosyRadience, price: 599 },
  { label: "Glided Gradient", src: glidedGradient, price: 599 },
  { label: "Luxe Gold Tip", src: luxeGoldTip, price: 599 },
  { label: "Tied In Gold", src: tiedInGold, price: 599 },
  { label: "Twirl and Shine", src: twirlAndShine, price: 599 },
  { label: "Golden Swirl", src: goldenSwirl, price: 599 },
  { label: "Golden Fusion", src: goldenFusion, price: 599 },
  { label: "Soft Sparkle", src: softSparkle, price: 599 },
  { label: "Glitter French", src: glitterFrench, price: 599 },
  { label: "Glitter Swirl", src: glitterSwirl, price: 599 },
  { label: "Starlight French", src: starlightFrench, price: 599 },
  { label: "Holographic Ombre", src: holographicOmbre, price: 599 },
];
