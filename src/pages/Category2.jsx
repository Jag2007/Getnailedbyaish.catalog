...
const designs = [
  { label: "Blackout Hearts", price: 549, src: blackoutHearts },
  { label: "Blushing Blooms", price: 549, src: blushingBlooms },
  { label: "Chrome Kiss", price: 549, src: chromeKiss },
  { label: "Pearl Chrome", price: 549, src: pearlChrome },
  { label: "Rosy Delight", price: 549, src: rosyDelight },
  { label: "Soft Pink Chrome", price: 549, src: softPinkChrome },
  { label: "Basic French", price: 599, src: basicFrench },
  { label: "Lovey Dovey", price: 599, src: loveyDovey },
  { label: "Marbled Mauve", price: 599, src: marbledMauve },
  { label: "Golden Outline", price: 699, src: goldenOutline },
  { label: "Brownie Chrome", price: 699, src: brownieChrome },
  { label: "Blue Starlight", price: 699, src: blueStarlight },
  { label: "Black Swirls", price: 699, src: blackSwirls },
  { label: "French Floral", price: 699, src: frenchFloral },
  { label: "Basic French Chrome", price: 699, src: basicFrenchChrome },
  { label: "Mocha Bloom", price: 699, src: mochaBloom },
  { label: "Mocha Swirls", price: 699, src: mochaSwirls },
  { label: "Pastel Frenchies", price: 699, src: pastelFrenchies },
  { label: "Pearl French", price: 699, src: pearlFrench },
  { label: "Rich Red Ombre", price: 699, src: richRedOmbre },
  { label: "Soft Sparkle", price: 699, src: softSparkle },
  { label: "Starlight Tips", price: 699, src: starlightTips },
  { label: "Tortoise Treasure", price: 699, src: tortoiseTreasure },
  { label: "Dainty Swirls", price: 699, src: daintySwirls },
  { label: "Midnight Tips", price: 629, src: midnightTips },
  { label: "Baby Pink Frenchies", price: 629, src: babyPinkFrenchies },
  { label: "Sunshine Tips", price: 649, src: sunshineTips },
  { label: "Mauve Petals", price: 649, src: mauvePetals },
  { label: "Love Bite", price: 649, src: loveBite },
  { label: "French Cherry KISS", price: 679, src: frenchCherryKISS },
  { label: "Drama Queen", price: 749, src: dramaQueen },
  { label: "Plum Aura", price: 749, src: plumAura },
  { label: "Blushing Aura", price: 749, src: blushingAura },
  { label: "French Twist", price: 749, src: frenchTwist },
  { label: "Glided Blush", price: 749, src: glidedBlush },
  { label: "Daisy Dreams", price: 749, src: daisyDreams },
  { label: "Pretty in Pink", price: 729, src: prettyInPink },
  { label: "Just Cherry", price: 729, src: justCherry },
  { label: "Caramel Sunset", price: 799, src: caramelSunset },
  { label: "Cherry on Top", price: 799, src: cherryOnTop },
  { label: "Heart Me Red", price: 799, src: heartMeRed },
  { label: "Heart Me Black", price: 799, src: heartMeBlack },
  { label: "Romantic Aura", price: 799, src: romanticAura },
  { label: "Summer Ombre", price: 799, src: summerOmbre },
  { label: "Brown Chombre", price: 799, src: brownChombre },
  { label: "Studded Petals", price: 799, src: studdedPetals },
  { label: "Ombre Florals", price: 799, src: ombreFlorals },
  { label: "Maroon Bloom", price: 549, src: maroonBloom },
  { label: "Lilac Dream", price: 699, src: lilacDream },
  { label: "Spring Fling", price: 749, src: springFling },
  { label: "Marble Muse", price: 699, src: marbleMuse },
];
